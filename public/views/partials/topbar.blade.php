    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="user-nav d-sm-flex d-none d-lg-inline">
                    <span class="mr-2 d-none d-lg-block small text-right">Rui Costa</span>
                    <span class="mr-2 d-none d-lg-block small text-right">rui.costa@energiasimples.pt</span>
                </div>

                <img class="img-profile rounded-circle" src="/images/avatar/default.png" />
            </a>
