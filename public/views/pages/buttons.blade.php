        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>
                    ...
                    respective brand color. They are used on the user login and registration
                    pages.
                </p>
                <p>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>
                    ...
                    <code>.btn-icon-split</code> class and the markup in the examples below. The
                    examples below also use the <code>.text-white-50</code> helper class on the
