...
<html lang="en">
    <head>
        ...
        <title>Energia Simples - Dashboard</title>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - CKEditor -->
                <li class="nav-item">
                    <a class="nav-link" href="ckeditor.html">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <p>
                                            Energia Simples makes extensive use of Bootstrap 4 utility classes in order
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span
                                >Copyright &copy; Energia Simples :: Powered By Rui Costa
                                rui.costa@energiasimples.pt</span
                            >
                        </div>
                    </div>
                </footer>
